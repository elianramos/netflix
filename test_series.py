...
class TestSeleccionarPerfilYSeries(unittest.TestCase):
    ...
    def test_seleccionar_perfil_y_series(self):
        ...
        try:
            series_link = driver.find_element(By.XPATH, "//a[@href='/browse/genre/83']")
            series_link.click()  
        except Exception as e:
            raise Exception("No se pudo encontrar el enlace de Series.") from e

       
        time.sleep(5)
        self.assertIn("Series", driver.title)  

    def tearDown(self):
        try:
           
            screenshot_path = "screenshot_seleccionar_perfil_y_series.png"
...
if __name__ == "__main__":
    ...
    unittest.main(
        testRunner=HtmlTestRunner.HTMLTestRunner(
            output="reportes",  
            report_name="Reporte_SeleccionarPerfilYSeries", 
